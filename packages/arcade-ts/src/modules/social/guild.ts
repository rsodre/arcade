...
export class GuildModel {
  ...
  static from(identifier: string, model: any) {
    ...
    return new GuildModel(identifier, id, open, free, guildCount, metadata, socials);
  }
  ...
  static default(identifier: string) {
    return new GuildModel(identifier, 0, false, false, 0, Properties.default(), Socials.default());
  }
...
export const Guild = {
  parse: (entity: ParsedEntity<SchemaType>) => {
    return GuildModel.from(entity.entityId, entity.models[NAMESPACE]?.[MODEL_NAME]);
  },
