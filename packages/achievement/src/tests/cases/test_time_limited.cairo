//! Test case 3: Time-Limited achievement
//!
//! Settings:
//! - Start = 0
//! - End > 0
//!
//! Expected behavior:
//! - Achievement starts immediately and remains active until end timestamp
//! - Achievement becomes inactive after end time
...
const ACHIEVEMENT_ID: felt252 = 'TIME-LIMITED';
...
#[test]
fn test_time_limited_achievement_creation() {
    let (world, systems, context) = spawn_game();
    let store = StoreTrait::new(world);

    // [Create] Achievement with time-limited settings
...
#[test]
fn test_time_limited_achievement_completion_once() {
    let (world, systems, context) = spawn_game();
    let store = StoreTrait::new(world);
...
#[test]
fn test_time_limited_achievement_claim() {
    let (world, systems, context) = spawn_game();
    let store = StoreTrait::new(world);
    ...
    // [Progress] Complete the achievement before end
    set_block_timestamp(1000);
    systems
        .achiever
