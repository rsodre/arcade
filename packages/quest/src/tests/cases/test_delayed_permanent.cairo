//! Test case 2: Delayed Permanent quest
//!
//! Settings:
//! - Start > 0
//! - End = 0
...
//!
//! Expected behavior:
//! - Quest becomes active at start timestamp and remains active forever
//! - Quest is inactive before start time
...
const QUEST_ID: felt252 = 'DELAYED-PERMANENT';
...
fn test_delayed_permanent_quest_creation() {
    ...
    // [Create] Quest with delayed permanent settings
...
#[test]
fn test_delayed_permanent_quest_completion_once() {
    let (world, systems, context) = spawn_game();
    let store = StoreTrait::new(world);
...
#[test]
fn test_delayed_permanent_quest_claim() {
    let (world, systems, context) = spawn_game();
    let store = StoreTrait::new(world);
    ...
    // [Progress] Complete the quest after start
