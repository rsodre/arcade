...
impl AchievementImpl of AchievementTrait {
    ...
    fn new(
        ...
        // [Return] Achievement
        Achievement { world_address, namespace, id: achievement_id, points, whitelisted: false, }
    }
...
mod tests {
    ...
    #[test]
    fn test_achievement_set_points() {
        let mut achievement = AchievementTrait::new(
            WORLD_ADDRESS, NAMESPACE, ACHIEVEMENT_ID, POINTS
        );
        achievement.set_points(POINTS + 1);
