...
!(() => {
  ...
  function ot() {
    let t = 12,
      e = "";
    while (0 < t--) e += it[(62 * Math.random()) | 0];
    return e;
  }
  function st(e) {
    const a = [];
  ...
  var Nt = (r, i) => (t, e, a, n) => r.call(i, t, e, a, n);
  function Ot(t) {
    const e = ((t) => {
      const e = [];
      let a = 0;
  ...
  function be(e, t) {
    const {
      ceFn: a = "svg" === e.tag
        ? ((t) => w.createElementNS("http://www.w3.org/2000/svg", t))
        : ((t) => w.createElement(t)),
    ...
    (y = {
      ...
      provides(t) {
        t.generateLayersText = (t, e) => {
          ...
          return (
            u &&
              ((s = Number.parseInt(getComputedStyle(t).fontSize, 10)),
      ...
      return t
        ...
        .reduce(
          (t, e) => {
            ...
            if (((n = Number.parseFloat(n)), isNaN(n))) return t;
            switch (e) {
              case "grow":
                t.size = t.size + n;
                break;
  ...
  !((t, e) => {
    ...
    [
      ...
      },
      {
        ...
        provides(t) {
          t.generateAbstractTransformGrouping = (t) => {
