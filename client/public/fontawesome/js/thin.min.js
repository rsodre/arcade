...
!(function () {
  ...
  const u = new Set();
  Object.keys(r[M]).map(u.add.bind(u)),
    Object.keys(r.sharp).map(u.add.bind(u)),
    Object.keys(r["sharp-duotone"]).map(u.add.bind(u));
  const h = z || {};
  h[L] || (h[L] = {}),
    h[L].styles || (h[L].styles = {}),
    h[L].hooks || (h[L].hooks = {}),
    h[L].shims || (h[L].shims = []);
  var p = h[L];
  function b(z) {
  ...
  function g(c, l, s) {
    var { skipHooks: z = !1 } = 2 < arguments.length && void 0 !== s ? s : {},
      s = b(l);
    "function" != typeof p.hooks.addPack || z
      ? (p.styles[c] = { ...(p.styles[c] || {}), ...s })
      : p.hooks.addPack(c, b(l)),
      "fas" === c && g("fa", l);
  }
  var w = {
    "spider-web": [
