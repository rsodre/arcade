...
export const DEFAULT_TOKENS_PROJECT: string = "c7e-arcade-tokens";
export const BLACKLISTS: bigint[] = [
  BigInt("0x07fc27ad206a82c097260f92d822de9bf205095205747fadef9c596714491437"),
];
